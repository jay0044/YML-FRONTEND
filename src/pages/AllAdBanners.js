    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 p-5">
      ...
      {allBanner.length > 0 ? (
        allBanner.map((banner) => (
          <div
            key={banner._id}
            className="relative w-full h-48 bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300"
          >
            <img
      ...
      {/* Add New Banner Card */}
      <div
        className="relative w-full h-48 border-2 border-dashed border-sky-400 bg-white rounded-xl flex items-center justify-center cursor-pointer hover:bg-sky-50 transition"
